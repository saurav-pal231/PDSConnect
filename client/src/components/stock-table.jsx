...
export default function StockTable({ shops }) {
  ...
  const getOverallStatus = (shop) => {
    ...
    if (statuses.includes('critical')) return { label: 'Critical', variant: 'destructive' };
    if (statuses.includes('low')) return { label: 'Low Stock', variant: 'secondary' };
    return { label: 'Good Stock', variant: 'default' };
  };
